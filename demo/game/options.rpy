...
define config.name = _("IDETestProject")
...
define build.name = "IDETestProject"
...
define config.save_directory = "IDETestProject-1762312285"
...
#define config.default_transform = three_quarter_view
