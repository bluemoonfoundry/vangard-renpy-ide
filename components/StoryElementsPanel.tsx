                    ...
                    <div id="story-tab-panel-storyData" role="tabpanel" className="divide-y divide-primary">
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                isCollapsed={collapsedSubsections.characters}
                                onToggle={() => toggleSubsection('characters')}
                                actions={
                                    <button onClick={() => onOpenCharacterEditor('new_character')} className="px-2 py-1 rounded bg-accent hover:bg-accent-hover text-white text-xs font-bold">+ Add</button>
                                }
                            />
                            {!collapsedSubsections.characters && (
                                characterList.length === 0
                                    ? <p className="text-xs text-secondary italic">No characters defined yet.</p>
                                    : (
                                        <div
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                isCollapsed={collapsedSubsections.variables}
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                isCollapsed={collapsedSubsections.screens}
                    ...
                    <div id="story-tab-panel-assets" role="tabpanel" className="divide-y divide-primary">
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                isCollapsed={collapsedSubsections.images}
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                isCollapsed={collapsedSubsections.audio}
                    ...
                    <div id="story-tab-panel-composers" role="tabpanel" className="divide-y divide-primary">
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                count={scenes.length}
                                isCollapsed={collapsedSubsections.scenes}
                                onToggle={() => toggleSubsection('scenes')}
                                actions={
                                    <button onClick={() => onCreateScene()} className="px-2 py-1 rounded bg-accent hover:bg-accent-hover text-white text-xs font-bold">+ New</button>
                                }
                            />
                            {!collapsedSubsections.scenes && (
                                <ul className="space-y-2 mt-2">
                                    {scenes.map(scene => (
                                        <li key={scene.id} className="p-2 rounded-md bg-secondary border border-primary flex items-center justify-between group hover:shadow-md transition-shadow">
                                            <div className="flex-grow cursor-pointer" onClick={() => onOpenScene(scene.id)}>
                                                <p className="font-semibold text-xs">{scene.name}</p>
                                            </div>
                                            <button
                                    ...
                                    {scenes.length === 0 && <p className="text-xs text-secondary italic">No scenes created yet.</p>}
                                </ul>
                            )}
                        </div>
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                title="ImageMaps"
                                count={imagemaps.length}
                                isCollapsed={collapsedSubsections.imagemaps}
                                onToggle={() => toggleSubsection('imagemaps')}
                                actions={
                                    <button onClick={() => onCreateImageMap()} className="px-2 py-1 rounded bg-accent hover:bg-accent-hover text-white text-xs font-bold">+ New</button>
                                }
                            />
                            {!collapsedSubsections.imagemaps && (
                                <ul className="space-y-2 mt-2">
                                    {imagemaps.map(imagemap => (
                                        <li key={imagemap.id} className="p-2 rounded-md bg-secondary border border-primary flex items-center justify-between group hover:shadow-md transition-shadow">
                                            <div className="flex-grow cursor-pointer" onClick={() => onOpenImageMap(imagemap.id)}>
                                                <p className="font-semibold text-xs">{imagemap.name}</p>
                                            </div>
                                            <button
                                    ...
                                    {imagemaps.length === 0 && <p className="text-xs text-secondary italic">No imagemaps created yet.</p>}
                                </ul>
                            )}
                        </div>
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                count={screenLayouts.length}
                                isCollapsed={collapsedSubsections.screenLayouts}
                                onToggle={() => toggleSubsection('screenLayouts')}
                                actions={
                                    <button onClick={() => onCreateScreenLayout()} className="px-2 py-1 rounded bg-accent hover:bg-accent-hover text-white text-xs font-bold">+ New</button>
                                }
                            />
                            {!collapsedSubsections.screenLayouts && (
                                <ul className="space-y-2 mt-2">
                    ...
                    <div id="story-tab-panel-tools" role="tabpanel" className="divide-y divide-primary">
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                isCollapsed={collapsedSubsections.snippets}
                                onToggle={() => toggleSubsection('snippets')}
                            />
                            {!collapsedSubsections.snippets && (
                                <div className="mt-2">
                                    <SnippetManager
                        ...
                        <div className="p-4">
                            <SubsectionHeader
                                ...
                                count={menuTemplates.length}
                                isCollapsed={collapsedSubsections.menuTemplates}
                                onToggle={() => toggleSubsection('menuTemplates')}
                                actions={
                                    <button onClick={onCreateMenuTemplate} className="px-2 py-1 rounded bg-accent hover:bg-accent-hover text-white text-xs font-bold">+ New</button>
                                }
                            />
                            {!collapsedSubsections.menuTemplates && (
                                <div className="mt-2">
                                    <MenuTemplateManager
