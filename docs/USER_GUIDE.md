...
[Table of contents will be auto-generated by Pandoc]
...
### 4.1.4 Canvas Navigation (All Canvases)
...
### 5.1.1 Using the Story Canvas for Narrative Structure
...
### 5.1.2 Using the Route Canvas for Plot Structure
...
### 5.1.3 Using the Choice Canvas for Player Experience
...
### 5.1.4 Combining All Three Canvases
...
### 5.2.1 Character Database (Characters Tab)
...
### 5.3.2 Adding and Configuring Choices
...
### 5.4.3 Comparison: Palette vs. Toolbox
...
### 5.6.3 Using Variables in Choices
...
### 5.7.3 Using Sticky Notes for Annotations
...
### 5.7.4 Collaborative Workflow Considerations
...
### 5.7.6 Writer-Specific Keyboard Shortcuts
...
### 6.1.1 Image Assets Tab Overview
...
### 6.1.6 Filtering and Searching Images
...
### 6.2.1 Audio Assets Tab Overview
...
### 6.2.2 Scanning External Audio Directories
...
### 6.6.3 Why Artists Should Use This
...
### 6.7.1 Organizing Assets by Scene/Character
...
### 6.7.4 Coordinating with Writers
...
### 6.7.5 Version Control for Assets
...
### 6.7.7 Testing with Scene Composer
...
### 6.7.8 Leveraging Quick Code Copy
...
### 7.1.3 Advanced Editing Techniques
...
### 7.2.3 Customizing Colors (If Supported)
...
### 7.3.3 Creating Custom Snippets
...
### 7.7.1 Configuring SDK Path (Review)
...
### 7.7.4 SDK Version Compatibility
...
### 7.9.3 Leveraging Diagnostics for QA
...
# Section 8: Complete Feature Reference
...
## 8.12 Keyboard Shortcuts (Complete List)
...
## 8.18 AI Story Generator (If Configured)
