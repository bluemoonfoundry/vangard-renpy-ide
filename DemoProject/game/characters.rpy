...
define h = Character("Hasper", color="#c8a2c8") # Female student council president, organized diplomat
define l = Character("Liam", color="#4682b4")    # Male librarian assistant, quiet historian
